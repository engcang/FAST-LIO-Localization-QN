...
visualization_msgs::Marker FAST_LIO_LOCALIZATION_QN_CLASS::get_loop_markers(const gtsam::Values &corrected_esti_in)
{
...
int FAST_LIO_LOCALIZATION_QN_CLASS::get_closest_keyframe_idx(const pose_pcd &front_keyframe, const vector<pose_pcd> &keyframes)
{
...
Eigen::Matrix4d FAST_LIO_LOCALIZATION_QN_CLASS::icp_key_to_subkeys(const pose_pcd &front_keyframe, const int &closest_idx, const vector<pose_pcd> &keyframes, bool &if_converged, double &score)
{
...
Eigen::Matrix4d FAST_LIO_LOCALIZATION_QN_CLASS::coarse_to_fine_key_to_subkeys(const pose_pcd &front_keyframe, const int &closest_idx, const vector<pose_pcd> &keyframes, bool &if_converged, double &score)
{
  Eigen::Matrix4d output_tf_ = Eigen::Matrix4d::Identity();
  if_converged = false;
